  ...
  switch (action) {
    ...
    case "edit": {
      ...
      const safe = Object.fromEntries(
        Object.entries(updates).filter(([k]) => allowed.includes(k)).map(([k, v]) => [k, typeof v === "string" ? v.trim() : v])
      );
...
async function log(sb, adminId, action, targetType, targetId, metadata = {}) {
